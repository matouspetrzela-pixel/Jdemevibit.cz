...
export function LabMatousSection() {
  return (
    <section className="relative border-t border-white/[0.08] bg-black/40 py-20 md:py-28">
      <div
      ...
      <div className="relative mx-auto max-w-6xl px-5">
        <div className="text-center">
          ...
          <p className="mt-2 font-mono text-sm text-zinc-500">
            AI Ambassador · komunita
          </p>
        </div>

        <div className="ht-terminal vc-panel ht-corner-frame mx-auto mt-14 max-w-4xl">
          ...
          <div className="grid gap-10 p-8 md:grid-cols-[200px_1fr] md:gap-12 md:p-10">
            <div className="flex justify-center md:justify-start">
              <div
                className="relative aspect-[3/4] w-full max-w-[180px] overflow-hidden rounded-sm border border-white/[0.12] shadow-[0_0_40px_rgba(0,240,255,0.06)]"
                aria-hidden
              >
                <div
            ...
            <div>
              ...
              <Link
                ...
                className="vc-vault-cta mt-8 inline-flex items-center gap-3"
              >
                Připoj se
